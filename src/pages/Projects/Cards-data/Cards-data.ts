...
const ProjectData: type[] = [
	...
	},
	{
		...
		description3:"Pro větší interaktivitu je také implementována možnost mazání jednotlivých položek a jejich detailního zobrazení. Uživatelé mohou kliknout na konkrétní položku, aby získali další informace, nebo ji kdykoliv smazat, pokud již není potřeba. Tento systém zajišťuje, že aplikace je přehledná a uživatelsky přívětivá, což přispívá k její efektivitě a využitelnosti.",
        playable: true,
	},
	{
		id: 2,
		...
		description: "Toto je pokročilejší slider, který jsem vytvořil v Reactu s použitím TypeScriptu (TSX) a stylování pomocí SCSS. Slider je navržen tak, aby efektivně zobrazoval data, která jsou uložena v souboru data.ts.",
		...
		description3:"Slider se automaticky posouvá po stanoveném časovém intervalu, což uživatelům umožňuje prohlížet jednotlivé položky bez nutnosti dalšího zásahu. Když však uživatel s sliderem aktivně nemanipuluje, automaticky se vrátí do původního stavu a opět začne s posunem. Tento design zajišťuje plynulé a intuitivní uživatelské prostředí, které zjednodušuje interakci a zvyšuje zážitek při prohlížení obsahu.",
	...
	},
	{
        ...
        description: "Toto je jednoduchá aplikace typu FAQ, inspirovaná stylem Netflixu. Je navržena tak, aby uživatelům usnadnila hledání odpovědí na často kladené otázky. Data jsou uložena v souboru data.ts jako pole objektů, což umožňuje efektivní manipulaci a přehledný přístup k informacím.",
		description2:"Jednotlivé otázky a odpovědi jsou zobrazeny v tabulkách pomocí funkce map, která iteruje přes každou položku v poli a generuje konkrétní komponenty pro každou položku. Tento způsob zobrazení zajišťuje, že jsou všechny informace prezentovány přehledně a srozumitelně.",
		description3:"Tyto informace jsou poté přeposlány do nejnižší komponenty, kde se finálně zobrazují uživatelům. Takto je zaručeno, že mají přístup k důležitým údajům na jednom místě, což přispívá k lepší uživatelské zkušenosti a snadnější navigaci v aplikaci.",
	...
	},
	{
		...
		image: img5,
		created: ["React", "Scss", "TS"],
        description: "Jedná se o klasickou hru had, která je primárně určena pro PC a zobrazuje se pouze na obrazovkách s minimálním rozlišením 1200 px. Hra je vyvinuta v Reactu a TypeScriptu a grafika je zobrazena na ploše canvas, což umožňuje plynulé animace a interakci.",
		description2:"Had je uložen jako pole objektů třídy, která obsahuje pozice X a Y. Hráči ovládají pohyb hada pomocí klávesových šipek, přičemž se posouvá pomocí funkcí unshift a pop spravovaných funkcí setInterval.",
		description3:"Dále hra obsahuje funkce pro detekci kolizí, takže se hráč musí vyhýbat stěnám a sám sobě. Kromě toho se na obrazovce náhodně objevuje jídlo pro hada, které se nikdy nevytváří na pozici samotného hada. Tato hra je skvělým způsobem, jak si procvičit reflexy a strategické myšlení.",
        playable: true,
	...
	},
	{
		...
		image: img6,
		created: ["React", "Scss", "TS"],
        description: "Tato aplikace zobrazuje aktuální souřadnice polohy vesmírné stanice ISS v reálném čase. Po otevření stránky aplikace okamžitě vyšle požadavek pomocí vlastního hooku useFetch. Během načítání dat se na obrazovce zobrazuje indikátor načítání, což informuje uživatele, že aplikace pracuje na získání potřebných informací.",
		...
		description3:"Celkově je aplikace užitečným nástrojem nejen pro nadšence do astronautiky a vesmíru, ale také pro každého, kdo má zájem sledovat pohyb naší orbitální stanice v reálném čase.",
        playable: true,
	},
	{
		id: 6,
